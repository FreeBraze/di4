...
<head>
  ...
  <title>单词趣味消消乐 - Unit 4 Social media matters</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="container">
    ...
    <div class="page unit-selection-page active" id="unitSelectionPage">
      ...
      <div class="units-container">
        <div class="unit-item">
          <div class="unit-circle"><span>Unit 4</span></div>
          <div class="unit-card" data-unit="4">
            <h3>Social media matters</h3>
            <p>社交媒体 | 共42个词汇</p>
          </div>
        </div>
      </div>
    ...
    <div class="page unit-detail-page" id="unitDetailPage">
      ...
      <div class="unit-circle"><span id="currentUnit">Unit 4</span></div>
      <div class="dropdown-area">
        <div class="dropdown" id="unitDropdown">Social media matters</div>
      </div>
    ...
    <div class="page game-page" id="gamePage">
      ...
      <div class="game-controls">
        <div class="control-group">
          <!-- 增加click-label类，点击交互 -->
          <div>单元:<span class="click-label" id="currentUnitDisplay">Unit 4</span></div>
  ...
  <script>
    ...
    const CONFIG = {
      wordLibrary: {
        4: [
          { english: "access", chinese: "n. 享用权；享用机会 vt. 存取，获取（尤指计算机数据）" },
          { english: "sake", chinese: "n. (for sb.’s/sth.’s ~, for the ~ of sb./sth.) 为了某人/某事的缘故" },
          { english: "startle", chinese: "vt. 使（某人）吃惊；吓（某人）一跳" },
          { english: "addict", chinese: "vt. 使沉溺；使入迷 n. 对…着迷的人" },
          { english: "addiction", chinese: "n. 入迷；嗜好" },
          { english: "brand‑new", chinese: "a. 全新的；崭新的；未用过的" },
          { english: "academic", chinese: "a. 学术的（尤指与学院或大学教育有关）" },
          { english: "decline", chinese: "vi. 减少；变糟；衰退 v. 谢绝；（礼貌地）拒绝 n.（数量的）减少；（质量的）下降" },
          { english: "given", chinese: "prep. 考虑到；鉴于" },
          { english: "dramatic", chinese: "a. ①巨大而突然的；急剧的 ②激动人心的；给人深刻印象的" },
          { english: "responsible", chinese: "a. ①有责任心的；可靠的；可信赖的 ②应承担责任的" },
          { english: "compromise", chinese: "vt. 危及；损害 n. 妥协；和解" },
          { english: "impact", chinese: "v. 对…有作用或影响 n. 作用；影响" },
          { english: "absorption", chinese: "n. ①全神贯注；专心致志 ②（对液体、气体或热量的）吸收" },
          { english: "generate", chinese: "vt. 产生；创造" },
          { english: "psychological", chinese: "a. 心理的；心理学的" },
          { english: "depression", chinese: "n. ①抑郁症 ②沮丧；消沉" },
          { english: "considerable", chinese: "a. 相当大的（尤指能产生影响或很重要）" },
          { english: "essential", chinese: "a. ①绝对必要的；必不可少的 ②本质的；基本的；根本的" },
          { english: "significant", chinese: "a. ①重要的；意义重大的 ②相当数量的；显著的" },
          { english: "contribute", chinese: "vi. (~ to sth.) 促成，造成（某事发生）" },
          { english: "approximately", chinese: "ad.（数量、时间等方面）大致，近似" },
          { english: "predictable", chinese: "a. 可预料的，可预见的（有时含贬义）" },
          { english: "apparent", chinese: "a. 显而易见的；明白的" },
          { english: "symptom", chinese: "n. ①症状 ②（大问题的）迹象，征兆，征候" },
          { english: "numerous", chinese: "a. 许多的；很多的" },
          { english: "trend", chinese: "n. 趋势；趋向；倾向；动向" },
          { english: "preliminary", chinese: "a. 初步的；预备的" },
          { english: "post", chinese: "v.（在网站上）公布，发布（信息）；发（帖）" },
          { english: "attribute", chinese: "vt. (~ sth. to sb./sth.) 把…归因于" },
          { english: "comparison", chinese: "n. 比较" },
          { english: "interfere", chinese: "vi. 介入；干涉；干预" },
          { english: "withdrawal", chinese: "n. ①不参加；退出 ②撤走；收回；取回" },
          { english: "encounter", chinese: "n. ①相遇；邂逅 ②遭遇；经历 vt. ①偶然碰到（某人） ②遇到，遭遇（尤指问题或反对）" },
          { english: "contact", chinese: "n. 联系；联络；交往 vt.（写信、打电话）联系（某人）" },
          { english: "novelty", chinese: "n. 新颖；新奇性" },
          { english: "survive", chinese: "v.（经历事故、战争或疾病后）活下来，幸存" },
          { english: "disastrous", chinese: "a. 极其糟糕的；极为失败的；灾难性的" },
          { english: "exhaust", chinese: "vt. ①使精疲力竭 ②用完；耗尽" },
          { english: "undermine", chinese: "vt. 逐渐削弱（或损害）" },
          { english: "compulsive", chinese: "a. 难以抑制的；冲动的" },
          { english: "extent", chinese: "n. 程度；限度；范围" }
        ]
      },
      unitInfo: { 4: { title: "Unit 4", topic: "Social media matters", desc: "社交媒体" } },
      audioMute: false,
      audioCtx: null
    };
    // 游戏状态全局变量
    ...
    function setupGame() {
      ...
      gameState = {
        ...
        mode: gameState.mode, unit: 4, diff: Number(DOM.diffSel.value)
      };
      // 更新页面显示文字
      const unitInfo = CONFIG.unitInfo[4];
      ...
      // 随机抽取指定数量单词
      const allWords = CONFIG.wordLibrary[4];
